...
if ($score) {
    ...
    if ($totalScore <= 4) {
        ...
        $stressDesc = "ต้องได้รับการประเมิน/ค้นหาความไม่สบายทางจิตเวชจากบุคลากรสาธารณสุข";
        $link = ' <div class="card border-0 shadow-sm">
        <div class="card-body text-center">
          <h5 class="card-title text-danger fw-bold">แบบคัดกรองโรคซึมเศร้า</h5>
        <a href="https://dmh.go.th/test/download/files/2Q%209Q%208Q%20(1).pdf" target="_blank">แบบคัดกรองโรคซึมเศร้า</a>
         </div>
            </div>';
    }
}
    ...
    <div class="container mt-4">
        <div class="survey-card shadow-sm rounded">
            <div class="row align-items-center">
                ...
                <!-- ข้อมูลผู้ใช้ -->
                <div class="col-sm-7">
                    <h3>สวัสดีคุณ <?php echo htmlspecialchars($user['username']); ?></h3>
                    ...
                    <?php if ($score): ?>
                        ...
                        <p class="text-muted" style="margin-bottom: 0;">
                            <?php echo htmlspecialchars($stressDesc); ?>
                        </p>
                        <br>
                        <?php echo $link; ?>
                        <br>
                        <div>
                            <a class="btn btn-primary me-2" href="test.php">ทำแบบสอบถาม</a>
                            <a class="btn btn-secondary" href="db/logout.php">ออกจากระบบ</a>
                        </div>
                        <br>
                </div>
            </div>
        ...
        <?php else: ?>
            <p class="text-danger fw-bold">คุณยังไม่ได้ทำแบบสอบถาม</p>
            <div>
                <a class="btn btn-primary me-2" href="test.php">ทำแบบสอบถาม</a>
                <a class="btn btn-secondary" href="db/logout.php">ออกจากระบบ</a>
            </div>
